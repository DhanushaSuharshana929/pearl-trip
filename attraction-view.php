...
<html dir="ltr" lang="en-US">
    <head>
        ...
        <title><?php echo $ATTRACTION->title;?> |Sri Lanka Suomi Travels</title>

        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
           <meta name="description" content="<?php echo $ATTRACTION->description;?>" http-equiv="description" />
        <meta name="keywords" content=" <?php echo $ATTRACTION->title;?>, suomi travel attractions, places to visit in sri lanka ,excursion, excursion in srilnaka ,attractions in sri lanka" http-equiv="keywords" />
                ...
                <div class="row">
                    <div class="col-md-8 carousel-type-2">
                        ...
                        <div id="transport_photos" class="galleria-slider">
                            ...
                            foreach ($ATTRACTION_PHOTO as $attraction_photo) {
                                ?>
                                <a href="upload/attraction/gallery/<?php echo $attraction_photo["image_name"]; ?>">
                                    <img src="upload/attraction/gallery/<?php echo $attraction_photo["image_name"]; ?>" data-title="" >
                                </a>
                                <?php }
                            ?>
                        ...
                        <div class="">
                            <h3 class="center" style="font-size: 24px;"><?php echo $ATTRACTION->title; ?></h3>

                            <p class="center"> <?php echo $ATTRACTION->description; ?></p>
                        ...
                        <div class="row " style="margin-left:15px;margin-right: 15px; ">
                            ...
                            foreach ($ATTRACTION as $key=> $attraction) {
                                ...
                                <div class="row more-back-col item1">
                                    ...
                                    <div class="col-md-8 " >
                                        <h3 class="center"><?php echo $attraction["title"]; ?></h3>
                                        <p class="center">
                                            <?php echo substr($attraction["description"],0,80); ?> 
                                        </p>
