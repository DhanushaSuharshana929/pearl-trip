                                            ...
                                            <div class="form-line">
                                                ...
                                                <select class="form-control place-select1 show-tick" autocomplete="off" type="text" id="type" name="type" required="TRUE">
                                                    ...
                                                    if ($TOUR_PACKAGE->type == '1') {
                                                        ...
                                                        <option value="1" selected="true">One Day Tours</option>
                                                        <option value="2">Round Tours</option>
                                                        <?php
                                                    } else {
                                                        ?>
                                                         <option value="2"  selected="true">Round Tours</option>
                                                         <option value="1">One Day Tours</option>
