...
<html dir="ltr" lang="en-US">
    ...
    <head>
        ...
        <title>Sri Lanka Suomi Travels |Privacy Policy</title>
    ...
    <body class="stretched">
        ...
        <div id="wrapper" class="clearfix">
            ...
            <div class="section nobottommargin notopmargin notoppadding bottompadding-lg  bgcolor-grey" style="padding-top:30px!important;padding-bottom: 30px!important;">                                                          
                <div class="container toppadding-sm">
                    <div class="row test">
                        <div class="col-md-8 col-md-offset-2" style="background: #fff;padding-top:30px;padding-bottom: 30px;">
                            <div class="p-padding" style="padding: 10px;">
