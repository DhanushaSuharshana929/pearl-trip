...
class TourPackage {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`type`,`title`,`image_name`,`price`,`short_description`,`description`,`queue` FROM `tour_package` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `tour_package` (`title`,`type`,`image_name`,`price`,`short_description`,`description`,`queue`) VALUES  ('"
                . $this->title . "', '"
                . $this->type . "', '"
                . $this->image_name . "', '"
                . $this->price . "', '"
